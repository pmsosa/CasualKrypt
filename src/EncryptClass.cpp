...
public:
    ...
    */
    void encrypt(string& text, string pass, char* inFileName, char* outFileName, bool RemoveOrigin, bool b64, bool pDisplacement, bool vectorAlgorithm, bool loud,bool header,bool pGUI);
    /**
...
void Encryptor::encrypt(string& text, string pass, char* inFileName, char* outFileName, bool RemoveOrigin, bool b64, bool pDisplacement,bool vectorAlgorithm, bool loud,bool header,bool pGUI) {

    flow = text;
    //cout << "FLOW GIVEN: " << flow << endl;
...
void Encryptor::vector_Algorithm() {
    ...
    //Precalculations
    if (password.length() >= flow.length()){
    ...
    for (unsigned i= 0; i < flow.length(); i+=(PocketSize)) {
