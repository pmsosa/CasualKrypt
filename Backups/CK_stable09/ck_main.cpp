    ...
    if (modeGiven && inFileGiven && outFileGiven && passGiven) {
        ...
        if (mode == ENC) {
            ...
            for (int i = 0; i<=repeat; i++) {
                ...
                message.encrypt(password, inFile, tempOrigFile, true, b64, pDisplacement,vectorAlgorithm, print,header,gui);
            }
            ...
            for (int i = 0; i<=repeat; i++) {
                ...
                message.decrypt(password, inFile, tempOrigFile , true, b64, pDisplacement,vectorAlgorithm, print,header,gui);
            }
        }
